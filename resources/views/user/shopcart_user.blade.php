    ...
    <section class="container">
        ...
        @if($cart_items->isEmpty())
            <div class="notification">
                ...
                <button class="book-now-btn" onclick="location.href='{{URL::to('/menu/'.$cart_id)}}'">Add now <i class="fa-solid fa-cart-plus"></i></button>
            </div>
        @else
        ...
        <div class="row button-group">
            <div class="col-sm-4 add-more" >
                <button class="book-now-btn " onclick="location.href='{{URL::to('/menu/'.$cart_id)}}'">Add more</button>
            </div>
