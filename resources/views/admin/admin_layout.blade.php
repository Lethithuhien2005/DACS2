    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="{{URL::to('/profile/'.$user_id)}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/reservation')}}">Add reservation</a></li>
						<li><a href="{{URL::to('/list-of-reservations/'.$type_user)}}">List reservations</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('list-of-feedbacks')}}">List Feedbacks</a></li>
                    </ul>
